...
public class DrawDynamicPathActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_draw_dynamic_path);
        ...
        DrawDynamicPathActivity.HeartGraphView v = new DrawDynamicPathActivity.HeartGraphView(this);
